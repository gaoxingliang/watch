...
public class HttpUtil {
    ...
    private static final ThreadLocal<URLConnection> conn = new ThreadLocal<>();
    ...
    public static void fetchFile(String url, Map<String, String> headers, File targetFile) throws Exception {
        // connection
        URL u = new URL(url);
